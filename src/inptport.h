...
/* input bits to this, the bit will be inverted while a vertical blank is happening. */
	...
	IPT_UI_EDIT_CHEAT,
  	...
  	IPT_UI_CHEAT,// Show_CHEATLIST_START
	IPT_UI_COMMAND, //CMD_PLUS
	IPT_UI_TOGGLE_AUTOFIRE, //AUTO_FIRE
	/* 8 player support */
...
#ifdef AUTO_FIRE // AUTO_FIRE									/* (providing invulnerabilty, level advance, and */
...
#define IPF_AUTOFIRE_SHIFT	28		/* Autofire flag shift */									/* so on). MAME will not recognize it when the */
#endif										/* -nocheat command line option is specified. */
